...
class OrdersAccept extends StatefulWidget {
  @override
  _OrdersAcceptState createState() => _OrdersAcceptState();
}

class _OrdersAcceptState extends State<OrdersAccept> {
  @override
    ...
    return Container(
      ...
      child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: List.generate(ObjectOrdersAccept.getOrders().length, (index) {
                return ItemUser(ObjectOrdersAccept.getOrders()[index]);
              }),
            ),
          )),
    );
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text("  Подтверждено",
                      style: TextStyle(color: Color.fromRGBO(0, 220, 0, 1), fontSize: 20),
                    ),
                  ],
                ),
