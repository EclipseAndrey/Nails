...
class OrdersAwait extends StatefulWidget {
  @override
  _OrdersAwaitState createState() => _OrdersAwaitState();
}

class _OrdersAwaitState extends State<OrdersAwait> {
  @override
    ...
    return Container(
      ...
      child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: List.generate(ObjectOrdersAwait.getOrders().length, (index) {
                return ItemUser(ObjectOrdersAwait.getOrders()[index]);
              }),
            ),
          )),
    );
