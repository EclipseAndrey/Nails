...
class GifHeader1State extends RefreshIndicatorState<GifHeader1>
  ...
  Widget buildContent(BuildContext context, RefreshStatus mode) {
    ...
    return GifImage(
      image: AssetImage("images/colibri.gif"),
...
class GifIndicatorExample1 extends StatefulWidget {
  ...
  GifIndicatorExample1(BuildContext context1){
    this.context1 = context1;
  }

  @override
  State<StatefulWidget> createState() {
    return GifIndicatorExample1State(context1);
  }
}
...
class GifIndicatorExample1State extends State<GifIndicatorExample1> {
  ...
  GifIndicatorExample1State(BuildContext context1){
    this.context1 = context1;
  }
